// This class is copied from Flurl project(based on MIT license): https://github.com/tmenier/Flurl
namespace Se.Url
{
    ...
    public class QueryParamCollection : IDictionary<string, object>
    {
        ...
        public static QueryParamCollection Parse(string queryString)
        {
            ...
            var pairs = (
                ...
                let pair = kv.Split('=')
                let key = pair[0]
                let value = pair.Length >= 2 ? UrlBuilder.DecodeQueryParamValue(pair[1]) : ""
        ...
        {
            return orderedKeys.Select(k => new KeyValuePair<string, object>(k, dict[k])).GetEnumerator();
        }
        ...
        {
            get { return orderedKeys.Select(k => dict[k]).ToArray(); }
        }
        #endregion
    }
}
